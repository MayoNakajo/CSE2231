...
public final class Program1GeneratedCode1 extends Program1 {
    ...
    private static void generateCodeForStatement(Statement s,
        ...
        // context is the program string instr name and statement
        // sequence cp is the computer program
        ...
        switch (s.kind()) {
            ...
            case CALL: {
                ...
                // call is an instruction in the program
                // context.hasKey(call)
                if (context.hasKey(call)) {
                    Map.Pair<String, Statement> pair = context.remove(call);
                    // recursion call
                    generateCodeForStatement(context.value(call), context, cp);
                    context.add(call, pair.value());
